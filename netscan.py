...
import psutil  # Importe psutil se for usado para outras funcionalidades, caso contrário, pode ser removido
...
class NetworkScanner:
    ...
    async def _nmap_scan(self, ip: str, arguments: str = "-sS -T4 --script=default") -> Optional[Dict]:
        """
        Executa um scan Nmap em um dispositivo e retorna informações como portas abertas, OS, etc.
        Usa -sS para SYN scan (mais rápido e stealthy) e scripts default para mais informações.
        Aumenta o timeout para Nmap que pode ser mais demorado.
        """
        try:
